...
class BlockTemplateManager extends TemplateManager {
	 ...
	 * @var string 模版路径
	 */
	const TEMPLATE_DIR = 'templates/blocks';

	/**
	 * @var string 自定义模版路径
	 */
	const CUSTOM_TEMPLATE_DIR = 'moredeal-templates/blocks';
	...
	/**
	 * @var BlockTemplateManager|null 实例对象
	 */
	private static ?BlockTemplateManager $instance = null;

	/**
	 * 获取单例
	 * @return BlockTemplateManager|null
	 */
	public static function getInstance(): ?BlockTemplateManager {
